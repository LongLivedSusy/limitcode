...
if __name__ == '__main__':
    ...
    filename = sys.argv[1]
    modelname = "SIG-HE-"+sys.argv[1].split("/")[-1].split("_")[0]
    ...
    sigPlot = smsPlotSIG(modelname, fileIN.HISTOGRAM, fileIN.SIG1, fileIN.SIG2, fileIN.SIG3, fileIN.ENERGY, fileIN.LUMI, fileIN.PRELIMINARY, fileIN.BOXES, "")
    sigPlot.Draw()
