...
from array import *
from .sms import *
from .smsPlotABS4SIG import *

# class producing the 2D plot with xsec colors
class smsPlotSIG(smsPlotABS):

    def __init__(self, modelname, histo, obsLimits, expLimits, expLimits2, expLimits3, energy, lumi, preliminary, boxes, label):
        self.standardDef(modelname, histo, obsLimits, expLimits, expLimits2, expLimits3, energy, lumi, preliminary, boxes)
        self.LABEL = label
        # canvas for the plot
    ...
    def DrawPaletteLabel(self):
        textCOLZ = rt.TLatex(0.96,0.52,"Expected significance")
        textCOLZ.SetNDC()
