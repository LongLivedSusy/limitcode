...
class smsPlotABS(object):
    ...
    # syst4Limits is a list of expected limits [NOMINAL, +1SIGMA, -1SIGMA]
    # label is a label referring to the analysis (e.g. RA1, RA2, RA2b, etc)
    def __init__(self, modelname, histo, syst0Limits, syst1Limits, syst2Limits, syst3Limits, syst4Limits, energy, lumi, preliminary, boxes, label):
        self.standardDef(modelname, histo, syst0Limits, syst1Limits, syst2Limits, syst3Limits, syst4Limits, energy, lumi, preliminary, boxes)
        self.LABEL = label
        self.c = rt.TCanvas("cABS_%s" %label,"cABS_%s" %label,300,300)
        self.histo = histo

    def standardDef(self, modelname, histo, syst0Limits, syst1Limits, syst2Limits, syst3Limits, syst4Limits, energy, lumi, preliminary, boxes):
        # which SMS?
    ...
    def DrawLegend(self):
        ...
        LSyst4P.SetPoint(0,self.model.Xmin+63*xRange/100, self.model.Ymax-1.20*yRange/100*10)
        LSyst4P.SetPoint(1,self.model.Xmin+70*xRange/100, self.model.Ymax-1.20*yRange/100*10)
        ...
        LSyst4.SetPoint(0,self.model.Xmin+63*xRange/100, self.model.Ymax-1.35*yRange/100*10)
        LSyst4.SetPoint(1,self.model.Xmin+70*xRange/100, self.model.Ymax-1.35*yRange/100*10)
        ...
        LSyst4M.SetPoint(0,self.model.Xmin+63*xRange/100, self.model.Ymax-1.50*yRange/100*10)
        LSyst4M.SetPoint(1,self.model.Xmin+70*xRange/100, self.model.Ymax-1.50*yRange/100*10)
         
        textSyst4 = rt.TLatex(self.model.Xmin+71*xRange/100, self.model.Ymax-1.50*yRange/100*10, "@ 300 fb^{-1}")
