...
from array import *
from .sms import *
from .smsPlotABS2 import *

# class producing the 2D plot with xsec colors
class smsPlotXSEC(smsPlotABS):

    def __init__(self, modelname, histo, syst0Limits, syst1Limits, syst2Limits, syst3Limits2, energy, lumi, preliminary, boxes, label):
        self.standardDef(modelname, histo, syst0Limits, syst1Limits, syst2Limits, syst3Limits2, energy, lumi, preliminary, boxes)
        self.LABEL = label
        # canvas for the plot
