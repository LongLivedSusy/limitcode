...
if __name__ == '__main__':
    ...
    filename = sys.argv[1]
    modelname = "HE-"+sys.argv[1].split("/")[-1].split("_")[0]
    ...
    xsecPlot = smsPlotXSEC(modelname, fileIN.HISTOGRAM, fileIN.SYST0, fileIN.SYST1, fileIN.SYST2, fileIN.SYST3, fileIN.ENERGY, fileIN.LUMI, fileIN.PRELIMINARY, fileIN.BOXES, "")
    xsecPlot.Draw()
