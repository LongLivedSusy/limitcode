...
fb = TFile(maindir+'Background/prompt-bg-results.root')
...
#hele = fb.Get('hElBaselineZone3p4To6p0_BinNumberMethod')
...
hmu.SetName('Mu')
#hpi = fb.Get('hPiBaselineZone3p4To6p0_BinNumberMethod')
hpi = fb.Get('hPiBaseline_BinNumberMethod')
hpi.SetName('Pi')
hfk = ffk.Get('hFkBaseline_BinNumberMethod')
hfk.SetName('Fake')
hobs = hele.Clone()
