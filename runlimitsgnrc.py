...
def getxsec(model):
    ...
    if 'T1qqqq' in model or 'T1btbt' in model:
        xsecFile = "/nfs/dust/cms/user/ssekmen/distrack/limits/limitcode/glu_xsecs_13TeV.txt"
    if 'T2bt' in model or 'T2tb' in model:
        xsecFile = "/nfs/dust/cms/user/ssekmen/distrack/limits/limitcode/stopsbot_xsecs_13TeV.txt"
...
maindir = '/nfs/dust/cms/user/ssekmen/distrack/limits/limitcode/'
