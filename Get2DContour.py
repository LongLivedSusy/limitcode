...
#                        if str(mg)==linesplit[0]:
#                            thyXsec[mg,mchi] = float(linesplit[1]) #pb
#                            thyXsecErr[mg,mchi] = 0.01*float(linesplit[2])               
#            print thyXsec
#        else: 
...
#            sys.exit()  
        ...
        for i in xrange(1,xsecGluino.GetNbinsX()+1):
            ...
            for j in xrange(1,xsecGluino.GetNbinsY()+1):
                ...
                if xLow >= yLow+diagonalOffset and xLow <= (mgMax-25)-binWidth/2:
                    #print 'hello', str(int(xLow))+" "+str(int(yLow))
        ...
        print 'xbin', xsecGluino.GetXaxis().GetNbins(), 'ybin', xsecGluino.GetYaxis().GetNbins()
...
#            xsecGluinoMinus = rt.swissCrossRebin(xsecGluinoMinus,"NE")
    ...
    for clsType in clsTypes:
        ...
        xsecUL[clsType].SetXTitle("top squark Mass [GeV]")
